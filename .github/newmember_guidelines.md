...
1. Visit the main [NewPackage repository](https://github.com/jravilab/NewPackage/); please start with the `README` doc in the repository.
2. Read our companion preprint [here](https://jravilab.github.io/publication).
3. Follow instructions from the repo `README` to install `NewPackage`, starting with [bioconductor installation instructions](https://bioconductor.org/install/).
4. Make sure you can build the package with `R CMD build` or run tests with `devtools`.
5. Check out [open issues](https://github.com/JRaviLab/NewPackage/issues), select a task [labeled quickfix](https://github.com/JRaviLab/NewPackage/issues?q=is%3Aissue+is%3Aopen+label%3Aquickfix), and ask to be assigned to it.
